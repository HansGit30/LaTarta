  ...
  return (
    <section className="relative z-50 footer w-full h-[250px]">
      ...
      <div className="w-full h-[90px] flex flex-col justify-center items-center pb-[10px]">
        <p className="text-sm font-quicksand">©2025 La Tarta – Dulzura artesanal para cada ocasión.</p>
        <p className="text-sm font-quicksand">Todos los derechos reservados.</p>
      </div>
    </section>
  )
}
