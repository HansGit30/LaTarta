...
const Beneficios = () => {
    return (
        <section className="w-full px-4 mb-20 md:mb-[200px]">
            <h2 className="font-julius text-xl mb-2 font-bold lg:text-3xl lg:px-10">Nos tomamos en serio nuestros <br className="hidden lg:block" /> postres artesanales</h2>
            ...
            <div className="lg:flex items-center justify-between lg:px-10">
                <article className="w-full">
                    ...
                    <div className="mb-10">
                        <h3 className="font-bold text-xl max-w-[250px] mb-2 font-julius lg:text-lg">Detalles Únicos en la Presentación</h3>
                ...
                <article className="w-full flex flex-col items-end md:items-center">
                    ...
                    <div className="mb-10">
                        <h3 className="font-julius text-end font-bold text-xl mb-2 lg:text-lg">Calidad de los Ingredientes</h3>
                ...
                <article className="w-full flex flex-col md:items-end">
                    ...
                    <div className="mb-5 md:text-end">
                        <h3 className="font-bold text-xl mb-2 font-julius lg:text-lg">Sabor Único y Auténtico</h3>
